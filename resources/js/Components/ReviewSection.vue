    ...
    <div class="p-6 testimonial-section-ten need-to-know-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-4 mb-3 review-card" v-for="review in reviews.slice(0, 6)" :key="review.id">
                <div class="card h-100 p-3">
                  <div class="card-body">
                    <div class="d-flex align-items-start gap-3">
                      <div class="rounded-circle overflow-hidden" style="width: 76px; height: 76px">
                        <img v-if="review.doctor_image || review.clinic_image"
                          :src="review.doctor_image || review.clinic_image" class="img-fluid object-fit-cover" alt="" />
                    ...
                    <star-rating :rating="review.rating" :star-size="20" :read-only="true" :increment="0.01"
                      :show-rating="false"></star-rating>
                    <div class="d-flex align-items-center gap-3 mt-4">
                      <img v-if="review.patient.image" :src="review.patient.image" class="rounded-circle"
